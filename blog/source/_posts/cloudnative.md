...
![cncf](http://ovci9bs39.bkt.clouddn.com/cncf.png "CNCF")

目前CNCF所托管的应用已达14个，下图为其公布的Cloud Native Landscape，给出了云原生生态的参考体系。
![Cloud Native Landscape](http://ovci9bs39.bkt.clouddn.com/CloudNativeLandscape_latest.jpg "Cloud Native Landscape")
...
笔者看到[Jimmy Song](https://jimmysong.io/posts/from-kubernetes-to-cloud-native/)对云原生架构中运用服务编排的总结是：
...
![monolithic][mon]
[mon]:http://ovcjgn2x0.bkt.clouddn.com/%E5%8D%95%E4%BD%93.jpg "传统的单体架构"
...
![cloud structure][sc]  
[sc]:http://ovci9bs39.bkt.clouddn.com/cloud%20structure.png "Spring Cloud整体架构图"

从上图Spring Cloud组件的架构可以看出在微服务架构中所必须的组件，包括：服务发现与注册、熔断机制、路由、全局锁、中心配置管理、控制总线、决策竞选、分布式会话和集群状态管理等基础组件。

![scvsk8s](http://ovci9bs39.bkt.clouddn.com/Microservices%20requirements%20%20.png "Spring Cloud VS Kubernetes")
...
### 参考
1. [云原生应用之路](https://jimmysong.io/posts/from-kubernetes-to-cloud-native/)
2. [架构演化：云原生时代正式开启](http://blog.csdn.net/sd7o95o/article/details/78644014)
3. [cncf/landscape](https://github.com/cncf/landscape)
